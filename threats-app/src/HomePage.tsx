  ...
  return (
    <div className="container-fluid bg-dark text-light min-vh-100 d-flex flex-column">
      ...
      <header className="d-flex justify-content-between align-items-center px-5 py-3 site-header" style={{ backgroundColor: '#333', height: '70%', maxHeight: '60px', width: '1990px', marginLeft: '-30px' }}>
        <a href="/rip_frontend" className="text-light fs-4 header-text">Мониторинг угроз</a>
        <Navbar />
      </header>
        ...
        <Carousel className="w-75" indicators={false} controls={true}>
          <Carousel.Item>
            <img
              ...
              src="/rip_frontend/static/web.jpg"
          ...
          <Carousel.Item>
            <img
              className="d-block w-100"
              src="/rip_frontend/static/ddos.jpg"
          ...
          <Carousel.Item>
            <img
              className="d-block w-100"
              src="/rip_frontend/static/vulnerability.jpg"
